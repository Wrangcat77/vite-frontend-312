export class Modal {
    ...
    clearFields() {
        const formElementsToClear = this.modal.querySelectorAll('input, select, textarea')
     ...
     */
    confirmCloseModal() {
        const confirmationMessage = 'Данные были изменены. Действительно хотите закрыть модальное окно?'
